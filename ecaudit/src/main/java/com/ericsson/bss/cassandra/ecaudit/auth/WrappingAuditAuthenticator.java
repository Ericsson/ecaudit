...
public class WrappingAuditAuthenticator implements IAuthenticator, IOptionsProvider
{
    ...
    {
        return new AuditingSaslNegotiator(clientAddress, wrappedAuthenticator.newAuditSaslNegotiator(clientAddress));
    }
    ...
    private class AuditingSaslNegotiator implements SaslNegotiator
    {
        ...
        public AuditingSaslNegotiator(InetAddress clientAddress, IAuditAuthenticator.AuditSaslNegotiator auditSaslNegotiator)
        {
