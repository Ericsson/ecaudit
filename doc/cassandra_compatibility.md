...
|-----------------|-----------------|--------------------------|
| 3.1.4 -> latest | Cassandra 5.0.6 | Cassandra 5.0.6 -> 5.0.9 |
...
| ecAudit Version  | Compiled With   | Compatible With           |
| ---------------- | --------------- |---------------------------|
| 3.1.0 -> latest  | Cassandra 4.1.6 | Cassandra 4.1.6 -> 4.1.12 |
...
| ecAudit Version  | Compiled With   | Compatible With           |
| ---------------- | --------------- |---------------------------|
| 2.10.0 -> latest | Cassandra 4.0.7 | Cassandra 4.0.2 -> 4.0.21 |
