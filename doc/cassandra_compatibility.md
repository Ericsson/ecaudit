...
| --------------- | ---------------- | -------------------------- |
| 2.7.0 -> latest | Cassandra 3.11.8 | Cassandra 3.11.2 -> 3.11.8 |
...
| ecAudit Version | Compiled With    | Compatible With            |
| --------------- | ---------------- | -------------------------- |
| 2.7.0 -> latest | Cassandra 3.0.22 | Cassandra 3.0.16 -> 3.0.22 |
...
| ecAudit Version | Compiled With    | Compatible With           |
| --------------- | ---------------- | ------------------------- |
| 2.7.0 -> latest | Cassandra 2.2.18 | Cassandra 2.2.8 -> 2.2.18 |
